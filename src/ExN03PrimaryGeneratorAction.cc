...
void ExN03PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
   ...
   //auto srcGenOffsetZ = srcCoreOffset-(0.5*ssShieldHeight-ssShieldTopVoidHeight-0.5*ssShieldCentralVoidHeight)+wCapsBaseHeight-0.5*wCapsBaseBottomHeight-wCapsBaseBoreHeight+0.5*ssShieldHeight;//when source is in the outer W capsule

//auto srcGenOffsetZ = wCapsBaseHeight-0.5*wCapsBaseBottomHeight-0.5*wCapsBaseBoreHeight+wCapsBaseHeight-0.5*wCapsBaseBottomHeight-wCapsBaseBoreHeight+0.5*ssShieldHeight+0.5*ssShieldHeight-ssShieldTopVoidHeight-0.5*ssShieldCentralVoidHeight+srcCoreOffset-0.5*wCapsCapHeight;//when source is in the outer W capsule
